package com.Shop.mobileRecharge;
...
public class TC_PostpaidMobile extends ShopSuiteRun implements BaseClass{
	...
	public void DocomoRecharge(Hashtable<String,String> data) {
		try {
