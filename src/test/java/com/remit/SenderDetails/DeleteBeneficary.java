...
public class DeleteBeneficary extends RemitSuiteRun implements BaseClass{
	...
	private DeleteBeneficary() {
		testName = "TC_DeleteBeneficary";
	...
	public void RemitDeleteBen(Hashtable<String,String> data) {
		try {
			count++;
