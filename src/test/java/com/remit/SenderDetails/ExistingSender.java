...
public class ExistingSender extends RemitSuiteRun implements BaseClass{
	...
	private ExistingSender() {
		testName = "TC_ExistingSender";
	...
	public void RemitCheckExistingUser(Hashtable<String,String> data) {
		try {
